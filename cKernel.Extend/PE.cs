...
namespace cKernel.Extend
{
    public class PE
    {
		...
		//for tbl_Route_Online_View
		public static void tbl_Route_Online_View(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("Id").Pc("GroupId").Pc("ReturnId").Pc("Type").Pc("Code").Pc("Name").Pc("OriginCode").Pc("OriginName").Pc("DestCode").Pc("DestName").Pc("Distance").Pc("Duration").Pc("Kind").Pc("TotalSchedule").Pc("StartWorkingDate").Pc("StopWorkingDate").Pc("Status").Pc("IsPrgCreatedDate").Pc("IsPrgUpdatedDate").Pc("IsPrgCreatedUserId").Pc("IsPrgUpdatedUserId")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		//for tbl_Route_Online_View_001
		public static void tbl_Route_Online_View_001(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("Id").Pc("Type").Pc("Code").Pc("Name").Pc("OriginCode").Pc("OriginName").Pc("DestCode").Pc("DestName").Pc("Distance").Pc("Duration").Pc("TotalSchedule").Pc("Kind").Pc("Status").Pc("IsPrgCreatedDate").Pc("IsPrgUpdatedDate").Pc("IsPrgCreatedUserId").Pc("IsPrgUpdatedUserId")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		//for tbl_Stop_View_001
		public static void tbl_Stop_View_001(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("Id").Pc("RouteId").Pc("WayId").Pc("OfficeId").Pc("Type").Pc("Code").Pc("Name").Pc("Address").Pc("Phone").Pc("Fax").Pc("Latitude").Pc("Longitude").Pc("OrderNumber").Pc("Distance").Pc("Duration").Pc("Passing").Pc("ShuttleBefore").Pc("Note").Pc("Status").Pc("IsPrgCreatedDate").Pc("IsPrgUpdatedDate").Pc("IsPrgCreatedUserId").Pc("IsPrgUpdatedUserId").Pc("OriginCode").Pc("DestCode")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		...
		//for slyt_GetReportAllRouteByDate
		public static void slyt_GetReportAllRouteByDate(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("FromDate").Pc("ToDate")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		//for slyt_InsertRouteTimeTable
		public static void slyt_InsertRouteTimeTable(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("ID").Pc("IDRoute").Pc("StartDate").Pc("Time").Pc("Number").Pc("TotalSeat").Pc("SeatBook")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		//for slyt_DeleteRouteTimeTableByDate
		public static void slyt_DeleteRouteTimeTableByDate(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("DepartureDate")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
		//for slyt_InsertOrUpdateStop
		public static void slyt_InsertOrUpdateStop(GCRequest obj, out GCResponse oo)
		{
		    var x = new X3(_cs, _isDebug, _loggedUserId ); x.SDA(D._a, DE._a); x.SDFD(D._fd, DE._fd); x.Init(obj);
		    var r = x.R().A().Pc("RouteId").Pc("WayId").Pc("OfficeId").Pc("Type").Pc("Name").Pc("Address").Pc("Distance").Pc("Duration").Pc("Passing").Pc("ShuttleBefore").Pc("Note")._CC()._CF()._CO()._CLO().L().S().EX().G();
		    oo = new GCResponse { Result = r._e ? 0 : 1, Records = r._d, TotalRecordCount = r._t, Message = r._m };
		}
